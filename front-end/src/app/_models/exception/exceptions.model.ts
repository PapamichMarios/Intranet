...
export const Exceptions = {
    /* Default */
    "GenericMessage": "Please contact support or try again later.",

    "UsernameEmailExistsException": "The username or email you provided already exist. ",
    "ResourceNotFoundException": "Resource not found. Please contact support or try again later.",
